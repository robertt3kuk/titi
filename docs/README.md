...
- `research/` — one folder per theme (`research/README.md` is the map,
  `research/STATE.md` is the resume point).
- `audits/` — raw audit reports, created by the first audit.

Rule: one `README.md` per feature or theme folder; create a folder only when
the feature exists.
